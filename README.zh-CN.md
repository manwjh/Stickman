...
- [快速开始](docs/zh-CN/GETTING_STARTED.md) - 5 分钟上手
- [配置指南](docs/zh-CN/CONFIG.md) - 详细配置说明
- [API 文档](docs/zh-CN/API.md) - 接口文档
- [开发文档](docs/zh-CN/DEVELOPMENT.md) - 二次开发
- [架构说明](docs/zh-CN/ARCHITECTURE.md) - 系统设计
...
欢迎提交 Issue 和 Pull Request！请参阅我们的[贡献指南](CONTRIBUTING.md)。
...
- 📧 邮箱: manwjh@126.com
- 🐦 推特: [@cpswang](https://twitter.com/cpswang)
- 🌐 站点: [zenheart.net](https://zenheart.net)
...
**Made with ❤️ by 深圳王哥&AI**

📧 manwjh@126.com · 🐦 [@cpswang](https://twitter.com/cpswang) · 🌐 [zenheart.net](https://zenheart.net)

[开始使用](docs/zh-CN/GETTING_STARTED.md) · [报告问题](https://github.com/your-repo/issues) · [English](README.md)
